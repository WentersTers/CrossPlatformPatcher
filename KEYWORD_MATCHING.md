...
Keyword matching is always enabled - no configuration needed.

To adjust thresholds:
```bash
# Lower fuzzy confidence (more matches)
--oww-fuzzy-match-confidence 0.70

# Higher fuzzy confidence (stricter matching)
--oww-fuzzy-match-confidence 0.85
```
